...
class AlchemyAlerts_000100(val gCtx : com.ligadata.OnLEPBase.EnvContext, val msg : com.ligadata.OnLEPBankPoc.BankPocMsg_100, val modelName:String, val modelVersion:String, val tenantId: String)
   extends ModelBase {
    ...
    def initialize : AlchemyAlerts_000100 = {
        ...
        ruleSetModel.AddMiningField("MOBILE_NUMBER_OUT", new MiningField("MOBILE_NUMBER_OUT","supplementary","",0.0,"",0.0,0.0,new StringDataValue(""),"",""))
        ...
        ruleSetModel.AddMiningField("ACCT_SHORT_NM_OUT", new MiningField("ACCT_SHORT_NM_OUT","supplementary","",0.0,"",0.0,0.0,new StringDataValue(""),"",""))
        ruleSetModel.AddMiningField("RUN_LDG_XAU_OUT", new MiningField("RUN_LDG_XAU_OUT","supplementary","",0.0,"",0.0,0.0,new StringDataValue(""),"",""))
        ruleSetModel.AddMiningField("ENT_DTE_OUT", new MiningField("ENT_DTE_OUT","supplementary","",0.0,"",0.0,0.0,new StringDataValue(""),"",""))
        ...
        ctx.dDict += ("MOBILE_NUMBER_OUT" -> new DataField("MOBILE_NUMBER_OUT", "String", dfoo2, "", "", ""))
        var dfoo3 : ArrayBuffer[(String,String)] =  new ArrayBuffer[(String,String)]()
        dfoo3 += ("gCtx" -> "valid")
        dfoo3 += ("msg" -> "valid")

        ctx.dDict += ("parameters" -> new DataField("parameters", "Any", dfoo3, "", "", ""))
        ...
        ctx.dDict += ("ACCT_SHORT_NM_OUT" -> new DataField("ACCT_SHORT_NM_OUT", "String", dfoo7, "", "", ""))
        var dfoo8 : ArrayBuffer[(String,String)] =  new ArrayBuffer[(String,String)]()
        ctx.dDict += ("OfflineEvent" -> new DataField("OfflineEvent", "String", dfoo8, "", "", ""))
        var dfoo9 : ArrayBuffer[(String,String)] =  new ArrayBuffer[(String,String)]()
        ctx.dDict += ("RUN_LDG_XAU_OUT" -> new DataField("RUN_LDG_XAU_OUT", "Double", dfoo9, "", "", ""))
        var dfoo10 : ArrayBuffer[(String,String)] =  new ArrayBuffer[(String,String)]()
        ctx.dDict += ("ENT_DTE_OUT" -> new DataField("ENT_DTE_OUT", "Int", dfoo10, "", "", ""))
...
class Derive_MaterializeOutputs (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val MaterializeOutputs = And(Put(ctx, "RUN_LDG_XAU_OUT", ctx.valueFor("msg").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.BankPocMsg_100].RUN_LDG_XAU), Put(ctx, "ACCT_SHORT_NM_OUT", ctx.valueFor("ClientPrefs").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.CustomerPreferences_100].ACCT_SHORT_NM), Put(ctx, "ENT_DTE_OUT", ctx.valueFor("msg").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.BankPocMsg_100].ENT_DTE), Put(ctx, "MOBILE_NUMBER_OUT", ctx.valueFor("ClientPrefs").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.CustomerPreferences_100].MOBILE_NUMBER))
...
class Derive_EBAlertType (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val EBAlertType = Or(And(Equal(ctx.valueFor("ClientPrefs").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.CustomerPreferences_100].MAX_EB_CNT, 7), Put(ctx, "AlertType", "EB1")), And(NotEqual(ctx.valueFor("ClientPrefs").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.CustomerPreferences_100].MAX_EB_CNT, 7), Put(ctx, "AlertType", "EB2")))
...
class Derive_ShouldEBOfflineEventBeIssued (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val ShouldEBOfflineEventBeIssued = And(Equal(ctx.valueFor("EBOfflineEvent").asInstanceOf[BooleanDataValue].Value, true), Equal(ctx.valueFor("SumOfAlertsSentToday").asInstanceOf[IntDataValue].Value, 0), Put(ctx, "OfflineEvent", "true"))
...
class Derive_SendNOResultDetermination (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val SendNOResultDetermination = And(Equal(ctx.valueFor("SendNOResult").asInstanceOf[StringDataValue].Value, "NO1"), Put(ctx, "AlertType", "NO1"), new ClientAlertsToday_NO001Sent_incrementBy(ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100], 1).incrementBy, new gCtx_value5_msg_ENT_ACC_NUM_Put(ctx.valueFor("gCtx").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBase.EnvContext], "AlertHistory", ctx.valueFor("msg").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.BankPocMsg_100], ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100]).Put, ctx.valueFor("MaterializeOutputs").asInstanceOf[BooleanDataValue].Value)
...
class Derive_SendOD2ResultDetermination (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val SendOD2ResultDetermination = And(Equal(ctx.valueFor("SendOD2Result").asInstanceOf[StringDataValue].Value, "OD2"), Put(ctx, "AlertType", "OD2"), new ClientAlertsToday_OD002Sent_incrementBy(ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100], 1).incrementBy, new gCtx_value9_msg_ENT_ACC_NUM_Put(ctx.valueFor("gCtx").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBase.EnvContext], "AlertHistory", ctx.valueFor("msg").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.BankPocMsg_100], ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100]).Put, ctx.valueFor("MaterializeOutputs").asInstanceOf[BooleanDataValue].Value)
...
class Derive_SendOD1ResultDetermination (name : String, dataType : String, validValues: ArrayBuffer[(String,String)], leftMargin : String, rightMargin : String, closure : String) 
    ...
    override def execute(ctx : Context) : BooleanDataValue = {
        val SendOD1ResultDetermination = And(Equal(ctx.valueFor("SendOD1Result").asInstanceOf[StringDataValue].Value, "OD1"), Put(ctx, "AlertType", "OD1"), new ClientAlertsToday_OD001Sent_incrementBy(ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100], 1).incrementBy, new gCtx_value11_msg_ENT_ACC_NUM_Put(ctx.valueFor("gCtx").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBase.EnvContext], "AlertHistory", ctx.valueFor("msg").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.BankPocMsg_100], ctx.valueFor("ClientAlertsToday").asInstanceOf[AnyDataValue].Value.asInstanceOf[com.ligadata.OnLEPBankPoc.AlertHistory_100]).Put, ctx.valueFor("MaterializeOutputs").asInstanceOf[BooleanDataValue].Value)

...
lazy val WriteMdlsDataToFileFromKafka = project.in(file("Utils/WriteMdlsDataToFileFromKafka")) dependsOn(Exceptions, InputOutputAdapterBase, KafkaSimpleInputOutputAdapters, KamanjaUtils)

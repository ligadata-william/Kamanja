...
object System_InpatientClaim_1000001_1430446866091 extends BaseMsgObj {
	override def TransformDataAttributes: TransformMessage = null
	override def NeedToTransformData: Boolean = false
	override def FullName: String = "System.InpatientClaim"
	...
	override def CreateNewMessage: BaseMsg  = new System_InpatientClaim_1000001_1430446866091()
...
class System_InpatientClaim_1000001_1430446866091 extends BaseMsg {
	override def IsFixed:Boolean = true;
	override def IsKv:Boolean = false;
    ...
    private def getByName(key: String): Any = {
	 ...
	 if(key.equals("clm_admsn_dt")) return clm_admsn_dt; 
	 if(key.equals("admtng_icd9_dgns_cd")) return admtng_icd9_dgns_cd; 
	 if(key.equals("clm_pass_thru_per_diem_amt")) return clm_pass_thru_per_diem_amt; 
	 if(key.equals("nch_bene_ip_ddctbl_amt")) return nch_bene_ip_ddctbl_amt; 
	 if(key.equals("nch_bene_pta_coinsrnc_lblty_am")) return nch_bene_pta_coinsrnc_lblty_am; 
	 if(key.equals("nch_bene_blood_ddctbl_lblty_am")) return nch_bene_blood_ddctbl_lblty_am; 
	 if(key.equals("clm_utlztn_day_cnt")) return clm_utlztn_day_cnt; 
	 if(key.equals("nch_bene_dschrg_dt")) return nch_bene_dschrg_dt; 
	 if(key.equals("clm_drg_cd")) return clm_drg_cd; 
	...
	private def getWithReflection(key: String): Any = {
	  ...
	  val fieldX = ru.typeOf[System_InpatientClaim_1000001_1430446866091].declaration(ru.newTermName(key)).asTerm.accessed.asTerm
  ...
  def populate(inputdata:InputData) = {
	  ...
	  private def populateCSV(inputdata:DelimitedData): Unit = {
	    ...
	    val arrvaldelim = "~"
		try{
			if(list.size < 23) throw new Exception("Incorrect input data size")
		...
		inputdata.curPos = inputdata.curPos+1
		clm_admsn_dt = com.ligadata.BaseTypes.IntImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		admtng_icd9_dgns_cd = com.ligadata.BaseTypes.StringImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		clm_pass_thru_per_diem_amt = com.ligadata.BaseTypes.DoubleImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		nch_bene_ip_ddctbl_amt = com.ligadata.BaseTypes.DoubleImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		nch_bene_pta_coinsrnc_lblty_am = com.ligadata.BaseTypes.DoubleImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		nch_bene_blood_ddctbl_lblty_am = com.ligadata.BaseTypes.DoubleImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		clm_utlztn_day_cnt = com.ligadata.BaseTypes.IntImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		nch_bene_dschrg_dt = com.ligadata.BaseTypes.IntImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
		clm_drg_cd = com.ligadata.BaseTypes.IntImpl.Input(list(inputdata.curPos));
		inputdata.curPos = inputdata.curPos+1
  ...
  private def populateJson(json:JsonData) : Unit = {
	...
	try{ 
		 ...
		 clm_admsn_dt = com.ligadata.BaseTypes.IntImpl.Input(map.getOrElse("clm_admsn_dt", 0).toString)
		 admtng_icd9_dgns_cd = com.ligadata.BaseTypes.StringImpl.Input(map.getOrElse("admtng_icd9_dgns_cd", "").toString)
		 clm_pass_thru_per_diem_amt = com.ligadata.BaseTypes.DoubleImpl.Input(map.getOrElse("clm_pass_thru_per_diem_amt", 0.0).toString)
		 nch_bene_ip_ddctbl_amt = com.ligadata.BaseTypes.DoubleImpl.Input(map.getOrElse("nch_bene_ip_ddctbl_amt", 0.0).toString)
		 nch_bene_pta_coinsrnc_lblty_am = com.ligadata.BaseTypes.DoubleImpl.Input(map.getOrElse("nch_bene_pta_coinsrnc_lblty_am", 0.0).toString)
		 ...
		 clm_utlztn_day_cnt = com.ligadata.BaseTypes.IntImpl.Input(map.getOrElse("clm_utlztn_day_cnt", 0).toString)
		 nch_bene_dschrg_dt = com.ligadata.BaseTypes.IntImpl.Input(map.getOrElse("nch_bene_dschrg_dt", 0).toString)
		 clm_drg_cd = com.ligadata.BaseTypes.IntImpl.Input(map.getOrElse("clm_drg_cd", 0).toString)
  ...
  private def populateXml(xmlData:XmlData) : Unit = {
	try{
	  ...
	  if(xml == null) throw new Exception("Invalid xml data")
			...
			val _clm_admsn_dtval_  = (xml \\ "clm_admsn_dt").text.toString 
			if (_clm_admsn_dtval_  != "")		clm_admsn_dt =  com.ligadata.BaseTypes.IntImpl.Input( _clm_admsn_dtval_ ) else clm_admsn_dt = 0
			...
			val _clm_pass_thru_per_diem_amtval_  = (xml \\ "clm_pass_thru_per_diem_amt").text.toString 
			if (_clm_pass_thru_per_diem_amtval_  != "")		clm_pass_thru_per_diem_amt =  com.ligadata.BaseTypes.DoubleImpl.Input( _clm_pass_thru_per_diem_amtval_ ) else clm_pass_thru_per_diem_amt = 0.0
			val _nch_bene_ip_ddctbl_amtval_  = (xml \\ "nch_bene_ip_ddctbl_amt").text.toString 
			if (_nch_bene_ip_ddctbl_amtval_  != "")		nch_bene_ip_ddctbl_amt =  com.ligadata.BaseTypes.DoubleImpl.Input( _nch_bene_ip_ddctbl_amtval_ ) else nch_bene_ip_ddctbl_amt = 0.0
			val _nch_bene_pta_coinsrnc_lblty_amval_  = (xml \\ "nch_bene_pta_coinsrnc_lblty_am").text.toString 
			if (_nch_bene_pta_coinsrnc_lblty_amval_  != "")		nch_bene_pta_coinsrnc_lblty_am =  com.ligadata.BaseTypes.DoubleImpl.Input( _nch_bene_pta_coinsrnc_lblty_amval_ ) else nch_bene_pta_coinsrnc_lblty_am = 0.0
			...
			val _clm_utlztn_day_cntval_  = (xml \\ "clm_utlztn_day_cnt").text.toString 
			if (_clm_utlztn_day_cntval_  != "")		clm_utlztn_day_cnt =  com.ligadata.BaseTypes.IntImpl.Input( _clm_utlztn_day_cntval_ ) else clm_utlztn_day_cnt = 0
			val _nch_bene_dschrg_dtval_  = (xml \\ "nch_bene_dschrg_dt").text.toString 
			if (_nch_bene_dschrg_dtval_  != "")		nch_bene_dschrg_dt =  com.ligadata.BaseTypes.IntImpl.Input( _nch_bene_dschrg_dtval_ ) else nch_bene_dschrg_dt = 0
			val _clm_drg_cdval_  = (xml \\ "clm_drg_cd").text.toString 
			if (_clm_drg_cdval_  != "")		clm_drg_cd =  com.ligadata.BaseTypes.IntImpl.Input( _clm_drg_cdval_ ) else clm_drg_cd = 0
	...
	com.ligadata.BaseTypes.IntImpl.SerializeIntoDataOutputStream(dos,clm_admsn_dt);
	com.ligadata.BaseTypes.StringImpl.SerializeIntoDataOutputStream(dos,admtng_icd9_dgns_cd);
	com.ligadata.BaseTypes.DoubleImpl.SerializeIntoDataOutputStream(dos,clm_pass_thru_per_diem_amt);
	com.ligadata.BaseTypes.DoubleImpl.SerializeIntoDataOutputStream(dos,nch_bene_ip_ddctbl_amt);
	com.ligadata.BaseTypes.DoubleImpl.SerializeIntoDataOutputStream(dos,nch_bene_pta_coinsrnc_lblty_am);
	com.ligadata.BaseTypes.DoubleImpl.SerializeIntoDataOutputStream(dos,nch_bene_blood_ddctbl_lblty_am);
	com.ligadata.BaseTypes.IntImpl.SerializeIntoDataOutputStream(dos,clm_utlztn_day_cnt);
	com.ligadata.BaseTypes.IntImpl.SerializeIntoDataOutputStream(dos,nch_bene_dschrg_dt);
	com.ligadata.BaseTypes.IntImpl.SerializeIntoDataOutputStream(dos,clm_drg_cd);
	...
	clm_admsn_dt = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
	admtng_icd9_dgns_cd = com.ligadata.BaseTypes.StringImpl.DeserializeFromDataInputStream(dis);
	clm_pass_thru_per_diem_amt = com.ligadata.BaseTypes.DoubleImpl.DeserializeFromDataInputStream(dis);
	nch_bene_ip_ddctbl_amt = com.ligadata.BaseTypes.DoubleImpl.DeserializeFromDataInputStream(dis);
	nch_bene_pta_coinsrnc_lblty_am = com.ligadata.BaseTypes.DoubleImpl.DeserializeFromDataInputStream(dis);
	nch_bene_blood_ddctbl_lblty_am = com.ligadata.BaseTypes.DoubleImpl.DeserializeFromDataInputStream(dis);
	clm_utlztn_day_cnt = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
	nch_bene_dschrg_dt = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
	clm_drg_cd = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
	{
			var arraySize = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
		val i:Int = 0;
		 if(arraySize > 0){ icd9_dgns_cds = new scala.Array[String](arraySize)
		...
		}}
	{
			var arraySize = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
		val i:Int = 0;
		 if(arraySize > 0){ icd9_prcdr_cds = new scala.Array[Int](arraySize)
		 for (i <- 0 until arraySize) {
		...
		}}
	{
			var arraySize = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
		val i:Int = 0;
		 if(arraySize > 0){ hcpcs_cds = new scala.Array[Int](arraySize)
		 for (i <- 0 until arraySize) {
	val inst = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);
		hcpcs_cds(i) = inst;
		}

  ...
  def SerializeObjectToJson(mdObj: BaseElemDef): String = {
    mdObj match {
      ...
      case o: MessageDef => {
        ...
        var Keys: Array[RelationKeyBase] = Array[RelationKeyBase]()
        if (o.containerType.partitionKey != null)
          paritionKeys = o.containerType.partitionKey
        if (o.containerType.Keys != null) {
          Keys = o.containerType.Keys
        }
        val json = ("Message" ->
          ("NameSpace" -> o.nameSpace) ~
          ("Name" -> o.name) ~
          ...
          ("PartitionKey" -> paritionKeys.toList) ~
          ("Keys" -> Keys.toList.map { keys =>
            (

...
object ConfigDefaults {
  ...
  def adapterDepJars: List[String] = List("jopt-simple-3.2.jar", "kafka_2.10-0.8.1.1.jar", "metrics-core-2.2.0.jar", "zkclient-0.3.jar", "kamanjabase_2.10-1.0.jar")

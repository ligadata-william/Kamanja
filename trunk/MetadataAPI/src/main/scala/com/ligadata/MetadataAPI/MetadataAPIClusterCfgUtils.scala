...
object MetadataAPIClusterCfgUtils {
  ...
  def AddNode(nodeId:String,nodePort:Int,nodeIpAddr:String,
    ...
    try{
      ...
      MetadataAPIDAOUtils.SaveObject(key.toLowerCase,value,MetadataAPIImpl.configStore)
  ...
  def RemoveNode(nodeId:String) : String = {
    try{
      ...
      val key = "NodeInfo." + nodeId
      MetadataAPIDAOUtils.DeleteObject(key.toLowerCase,MetadataAPIImpl.configStore)
  ...
  def RemoveConfig(cfgStr: String): String = {
	...
	adapters.foreach(a => {
      ...
      MetadataAPIDAOUtils.RemoveObjectList(keyList,MetadataAPIImpl.configStore)
  ...
  def UploadConfig(cfgStr: String): String = {
	...
	MetadataAPIDAOUtils.SaveObjectList(keyList,valueList,MetadataAPIImpl.configStore)

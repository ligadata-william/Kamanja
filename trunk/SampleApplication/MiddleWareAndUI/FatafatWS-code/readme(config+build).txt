...
project configuration is in file WebContent\WEB-INF\web.xml : 
	...
	- for logging: LogFilePath - must be full path like /usr/share/tomcat6/FatafatLogs/npario.log (if path is wrong app will still work, only log will not be written), of course the folder must give write permissions to the user running tomcat
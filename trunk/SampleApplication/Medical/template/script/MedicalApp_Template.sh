...
$KAMANJA_HOME/bin/kamanja $KAMANJA_HOME/input/SampleApplications/metadata/config/MetadataAPIConfig_Medical.properties upload cluster config $KAMANJA_HOME/config/ClusterConfig.json

...
class BankPocMsg_100 extends BaseMsg {
  ...
  /** FIXME: new fields to make Alchemy.xml parse... Data must be changed or model...
   *  ... check with customer with regard to the coding ... TransformDataAttributes 
   *  above is not considering these...  */

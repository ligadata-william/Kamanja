...
object System_CustomerPreferences_1000000 extends BaseContainerObj with RDDObject[System_CustomerPreferences_1000000] {
  ...
  override def GetRecentRDDForCurrentPartitionKey: RDD[System_CustomerPreferences_1000000] = { null }
  ...
  override def GetRDDForPartitionKey(partitionKey: Array[String], f: System_CustomerPreferences_1000000 => Boolean): RDD[System_CustomerPreferences_1000000] = { null }
...
class System_CustomerPreferences_1000000 extends BaseContainer with RDDBase {
  ...
  private def getByName(key: String): Any = {
    try {
      ...
      if (key.equals("minbalancealertoptout")) return minbalancealertoptout;
      if (key.equals("overdraftlimit")) return overdraftlimit;
  ...
  private def getWithReflection(key: String): Any = {
    ...
    val fieldX = ru.typeOf[System_CustomerPreferences_1000000].declaration(ru.newTermName(key)).asTerm.accessed.asTerm
  ...
  private def populateCSV(inputdata: DelimitedData): Unit = {
    ...
    try {
      ...
      inputdata.curPos = inputdata.curPos + 1
      minbalancealertoptout = com.ligadata.BaseTypes.StringImpl.Input(list(inputdata.curPos));
      inputdata.curPos = inputdata.curPos + 1
      overdraftlimit = com.ligadata.BaseTypes.DoubleImpl.Input(list(inputdata.curPos));
      inputdata.curPos = inputdata.curPos + 1
  ...
  private def assignJsonData(json: JsonData): Unit = {
    ...
    try {
      ...
      minbalancealertoptout = com.ligadata.BaseTypes.StringImpl.Input(map.getOrElse("minbalancealertoptout", "").toString)
      overdraftlimit = com.ligadata.BaseTypes.DoubleImpl.Input(map.getOrElse("overdraftlimit", 0.0).toString)
  ...
  private def populateXml(xmlData: XmlData): Unit = {
    try {
      ...
      val _minbalancealertoptoutval_ = (xml \\ "minbalancealertoptout").text.toString
      if (_minbalancealertoptoutval_ != "") minbalancealertoptout = com.ligadata.BaseTypes.StringImpl.Input(_minbalancealertoptoutval_) else minbalancealertoptout = ""
      val _overdraftlimitval_ = (xml \\ "overdraftlimit").text.toString
      if (_overdraftlimitval_ != "") overdraftlimit = com.ligadata.BaseTypes.DoubleImpl.Input(_overdraftlimitval_) else overdraftlimit = 0.0
  ...
  override def Serialize(dos: DataOutputStream): Unit = {
    try {
      ...
      com.ligadata.BaseTypes.StringImpl.SerializeIntoDataOutputStream(dos, minbalancealertoptout);
      com.ligadata.BaseTypes.DoubleImpl.SerializeIntoDataOutputStream(dos, overdraftlimit);
  ...
  override def Deserialize(dis: DataInputStream, mdResolver: MdBaseResolveInfo, loader: java.lang.ClassLoader, savedDataVersion: String): Unit = {
    try {
      ...
      if (prevVer == currentVer) {
        ...
        minbalancealertoptout = com.ligadata.BaseTypes.StringImpl.DeserializeFromDataInputStream(dis);
        overdraftlimit = com.ligadata.BaseTypes.DoubleImpl.DeserializeFromDataInputStream(dis);

...
import com.ligadata.FatafatBase.{ BaseMsg, BaseContainer, RDDBase, BaseContainerObj, MdBaseResolveInfo, MessageContainerBase, RDDObject, RDD, TimeRange }

object System_AlertHistory_1000000 extends BaseContainerObj with RDDObject[System_AlertHistory_1000000] {
  ...
  override def GetRecentRDDForCurrentPartitionKey: RDD[System_AlertHistory_1000000] = { null }
  ...
  override def GetRDDForPartitionKey(partitionKey: Array[String], f: System_AlertHistory_1000000 => Boolean): RDD[System_AlertHistory_1000000] = { null }
  override def GetRDDForPartitionKey(partitionKey: Array[String]): RDD[System_AlertHistory_1000000] = { null } // Should return some error/exception on facts if the size is too big
}

class System_AlertHistory_1000000 extends BaseContainer with RDDBase {
  override def IsFixed: Boolean = true;
  override def IsKv: Boolean = false;
  ...
  private def getByName(key: String): Any = {
    try {
      ...
      if (key.equals("lastalertdate")) return lastalertdate;
  ...
  private def getWithReflection(key: String): Any = {
    ...
    val fieldX = ru.typeOf[System_AlertHistory_1000000].declaration(ru.newTermName(key)).asTerm.accessed.asTerm
  ...
  private def populateCSV(inputdata: DelimitedData): Unit = {
    ...
    try {
      ...
      inputdata.curPos = inputdata.curPos + 1
      lastalertdate = com.ligadata.BaseTypes.IntImpl.Input(list(inputdata.curPos));
      inputdata.curPos = inputdata.curPos + 1
  ...
  private def assignJsonData(json: JsonData): Unit = {
    ...
    try {
      ...
      lastalertdate = com.ligadata.BaseTypes.IntImpl.Input(map.getOrElse("lastalertdate", 0).toString)
  ...
  private def populateXml(xmlData: XmlData): Unit = {
    try {
      ...
      val _lastalertdateval_ = (xml \\ "lastalertdate").text.toString
      if (_lastalertdateval_ != "") lastalertdate = com.ligadata.BaseTypes.IntImpl.Input(_lastalertdateval_) else lastalertdate = 0
  ...
  override def Serialize(dos: DataOutputStream): Unit = {
    try {
      ...
      com.ligadata.BaseTypes.IntImpl.SerializeIntoDataOutputStream(dos, lastalertdate);
  ...
  override def Deserialize(dis: DataInputStream, mdResolver: MdBaseResolveInfo, loader: java.lang.ClassLoader, savedDataVersion: String): Unit = {
    try {
      ...
      if (prevVer == currentVer) {
        ...
        lastalertdate = com.ligadata.BaseTypes.IntImpl.DeserializeFromDataInputStream(dis);

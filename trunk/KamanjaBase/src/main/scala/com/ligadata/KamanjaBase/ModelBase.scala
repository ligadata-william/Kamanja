...
*/
  def getAllAdapterUniqKvDataInfo(keys: Array[String]): Array[(String, (Long, String, List[(String, String)]))] // Get Status information from Final table. No Transaction required here.
